...
- Validate transcription, LLM responses, and severity logic
- Ensure ffmpeg installed for audio conversion
- Deploy backend (FastAPI) on Render / Railway / AWS  
- Host frontend (Next.js) on Vercel or Netlify
